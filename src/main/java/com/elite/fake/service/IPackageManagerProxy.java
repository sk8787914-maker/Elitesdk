...
public class IPackageManagerProxy extends BinderInvocationStub {
    ...
    public static class GetProviderInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = EliteInstaller.getBPackageManager().getProviderInfo(componentName, flags, BActivityThread.getUserId());
    ...
    public static class GetReceiverInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo receiverInfo = EliteInstaller.getBPackageManager().getReceiverInfo(componentName, flags, BActivityThread.getUserId());
    ...
    public static class GetActivityInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ActivityInfo activityInfo = EliteInstaller.getBPackageManager().getActivityInfo(componentName, flags, BActivityThread.getUserId());
    ...
    public static class GetServiceInfo extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ComponentName componentName = (ComponentName) args[0];
            int flags = MethodParameterUtils.toInt(args[1]);
            ServiceInfo serviceInfo = EliteInstaller.getBPackageManager().getServiceInfo(componentName, flags, BActivityThread.getUserId());
    ...
    public static class GetInstalledApplications extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            List<ApplicationInfo> installedApplications = EliteInstaller.getBPackageManager().getInstalledApplications(flags, BActivityThread.getUserId());
    ...
    public static class GetInstalledPackages extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            int flags = MethodParameterUtils.toInt(args[0]);
            List<PackageInfo> installedPackages = EliteInstaller.getBPackageManager().getInstalledPackages(flags, BActivityThread.getUserId());
    ...
    public static class ResolveContentProvider extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            int flags = MethodParameterUtils.toInt(args[1]);
            ProviderInfo providerInfo = EliteInstaller.getBPackageManager().resolveContentProvider(authority, flags, BActivityThread.getUserId());
    ...
    public static class GetPackagesForUid extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            if (uid == EliteInstaller.getHostUid()) {
                args[0] = BActivityThread.getBUid();
                uid = MethodParameterUtils.toInt(args[0]);
            }
            String[] packagesForUid = EliteInstaller.getBPackageManager().getPackagesForUid(uid);
    ...
    public static class getComponentEnabledSetting extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            ...
            ApplicationInfo applicationInfo = EliteInstaller.getBPackageManager().getApplicationInfo(packageName,0, BActivityThread.getUserId());
            if(applicationInfo != null){
